...
/**
 * ExtendedViewRequest Class Doc Comment
 *
 * @category Class
 * @description Extended View Request Body
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExtendedViewRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'extendedViewRequest';
    ...
    protected static $openAPITypes = [
        ...
        'add_ons' => '\OpenAPI\Client\Model\AddonsEVS',
        'custom_options' => '\OpenAPI\Client\Model\CustomOptions',
        'thin_file_indicator' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'thin_file_indicator' => 'thinFileIndicator'
    ];
    ...
    protected static $setters = [
        ...
        'thin_file_indicator' => 'setThinFileIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'thin_file_indicator' => 'getThinFileIndicator'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['thin_file_indicator'] = isset($data['thin_file_indicator']) ? $data['thin_file_indicator'] : null;
    }
     ...
     * Gets add_ons
     *
     * @return \OpenAPI\Client\Model\AddonsEVS|null
     */
     ...
     * Sets add_ons
     *
     * @param \OpenAPI\Client\Model\AddonsEVS|null $add_ons add_ons
     *
     * @return $this
     */
    ...
    /**
     * Gets thin_file_indicator
     *
     * @return string|null
     */
    public function getThinFileIndicator()
    {
        return $this->container['thin_file_indicator'];
    }

    /**
     * Sets thin_file_indicator
     *
     * @param string|null $thin_file_indicator What is the definition of thin file for the client? 4 = less than 5 trades (default) 3 = less than 4 trades 2 = less than 3 trades 1 = less than 2 trades 0 = no trades default value = 4
     *
     * @return $this
     */
    public function setThinFileIndicator($thin_file_indicator)
    {
        $this->container['thin_file_indicator'] = $thin_file_indicator;
