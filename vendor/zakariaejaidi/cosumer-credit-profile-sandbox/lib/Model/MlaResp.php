 ...
 * @link     https://openapi-generator.tech
 */
class MlaResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mlaResp';
     ...
     * Sets message_number
     *
     * @param string|null $message_number Message Number for mla.
     *
     * @return $this
     */
     ...
     * Sets message_text
     *
     * @param string|null $message_text Message Text matching message number is output in this element.
     *
     * @return $this
     */
