...
/**
 * EndTotalsResp Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EndTotalsResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'endTotalsResp';
     ...
     * Sets total_segments
     *
     * @param string|null $total_segments Total number of segments in report.
     *
     * @return $this
     */
     ...
     * Sets total_length
     *
     * @param string|null $total_length Length of report in bytes.
     *
     * @return $this
     */
