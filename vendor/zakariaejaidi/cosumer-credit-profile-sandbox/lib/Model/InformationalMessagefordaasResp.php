...
/**
 * InformationalMessagefordaasResp Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InformationalMessagefordaasResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'informationalMessagefordaasResp';
     ...
     * Sets message_number
     *
     * @param string|null $message_number Contains the two digit Message Code.
     *
     * @return $this
     */
     ...
     * Sets message_text
     *
     * @param string|null $message_text The message customized Message Text area.
     *
     * @return $this
     */
