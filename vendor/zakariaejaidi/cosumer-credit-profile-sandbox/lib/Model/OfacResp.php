...
/**
 * OfacResp Class Doc Comment
 *
 * @category Class
 * @description Present when \&quot;ofacmsg\&quot; is requested on input or via subcode and is allowed for the subcode.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OfacResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ofacResp';
     ...
     * Sets message_number
     *
     * @param string|null $message_number Message Number for ofac.
     *
     * @return $this
     */
     ...
     * Sets message_text
     *
     * @param string|null $message_text Message Text for corresponding message number.
     *
     * @return $this
     */
