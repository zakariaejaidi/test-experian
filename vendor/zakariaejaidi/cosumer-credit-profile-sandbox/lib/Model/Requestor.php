 ...
 * @link     https://openapi-generator.tech
 */
class Requestor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Requestor';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subscriber_code'] === null) {
            $invalidProperties[] = "'subscriber_code' can't be null";
        }
     ...
     *
     * @param string $subscriber_code Subscriber Number assigned by Experian
     *
     * @return $this
     */
